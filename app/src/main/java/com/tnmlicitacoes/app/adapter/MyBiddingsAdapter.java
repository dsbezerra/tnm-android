...
public class MyBiddingsAdapter extends RecyclerView.Adapter<MyBiddingsAdapter.VH> {

    private static final String TAG = "MyBiddingsAdapter";
    ...
    public MyBiddingsAdapter(Context context) {
