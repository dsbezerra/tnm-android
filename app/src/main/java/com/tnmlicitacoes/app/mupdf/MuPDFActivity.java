...
public class MuPDFActivity extends Activity implements FilePicker.FilePickerSupport
{
	...
	public void createUI(Bundle savedInstanceState) {
		...
		mDocView = new MuPDFReaderView(this) {
			...
			protected void onMoveToChild(int i) {
				...
				mPageNumberView.setText(String.format("%d de %d", i + 1,
						core.countPages()));
	...
	private void updatePageNumView(int index) {
		if (core == null)
			return;
		mPageNumberView.setText(String.format("%d de %d", index + 1, core.countPages()));
	}
	...
	private void makeButtonsView() {
		...
		mArrowBack = (ImageButton) mButtonsView.findViewById(R.id.arrowBack);
		...
		mSearchCancel = (ImageButton) mButtonsView.findViewById(R.id.cancelSearch);
