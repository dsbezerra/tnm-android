 ...
 *
 * NOTE(diego): This is almost the same code from Stripe but since we need to know when the
...
public class TnmExpiryDateEditText extends StripeEditText {
    ...
    public TnmExpiryDateEditText(Context context) {
        super(context);
        listenForTextChanges();
    }

    public TnmExpiryDateEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        listenForTextChanges();
    }

    public TnmExpiryDateEditText(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void listenForTextChanges() {
        addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                // NOTE(diego): Know right after type if the date is valid
                if (mExpiryDateEditListener != null) {
                    mExpiryDateEditListener.onExpiryDateChanged(mIsDateValid);
                }
    ...
    interface ExpiryDateEditListener {
        ...
        void onExpiryDateChanged(boolean isDateValid);
    }
}